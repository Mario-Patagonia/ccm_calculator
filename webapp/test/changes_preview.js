            ...
            jQuery.extend(FakeLrepConnector.prototype, {
                ...
                stringToAscii: function (sCodeAsString) {
                    ...
                    if (
                        ...
                        sAsciiString = sAsciiString.substring(
                            0,
                            sAsciiString.length - 1,
                        );
                    }
                    return sAsciiString;
                },
                    ...
                    return new Promise(function (resolve, reject) {
                        $.ajax({
                            ...
                            .then(function (oCachebusterContent) {
                                ...
                                var aChangeFilesPaths = Object.keys(
                                    oCachebusterContent,
                                        ...
                                        return new Promise(function (
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                function (
                                                                    ...
                                                                    if (
                                                                        ...
                                                                        oChange.content.extensionControllerContent =
                                                                            oFileDocument;
                                                                    }
                                                                    return oChange;
                                                                },
                                            ...
                                            if (aChangePromises.length > 0) {
                                                return Promise.all(
                                                    ...
                                                    function (aUpdatedChanges) {
                                                        aUpdatedChanges.forEach(
                                                            function (oChange) {
                                                                aProcessedChanges.push(
                                                                    oChange,
                                                                );
